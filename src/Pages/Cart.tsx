...
export function Cart() {
    ...
    const {totalCount,totalPrice, items}= useSelector<RootStateType,CartStateType>(state => state.Cart)

    const pizzas: pizzaCartData[] = Object.keys(items).map(key=>{
        return items[Number(key)].items[0]
    })
